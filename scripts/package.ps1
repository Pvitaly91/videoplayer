...
- У fullscreen панель накладається на відео, ховається після приблизно
  1200 мс лише під час Playing і повертається в нижній 100-pixel зоні.
- Кнопка «Зум області» або Z дозволяє виділити crop. Escape спочатку
  скасовує selection/zoom, а наступне натискання виходить із fullscreen.
